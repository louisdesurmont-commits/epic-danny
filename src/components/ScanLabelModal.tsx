...
export default function ScanLabelModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50">
      <div className="flex h-[100dvh] items-start justify-center overflow-y-auto p-3 sm:p-4">
        <div className="my-0 w-full max-w-3xl rounded-2xl bg-white shadow-xl sm:my-4">
          ...
          <div className="max-h-[calc(100dvh-72px)] overflow-y-auto overscroll-contain">
            <div className="grid gap-6 p-4 md:grid-cols-2 md:p-5">
              ...
              <div className="space-y-4">
                ...
                <div className="sticky bottom-0 flex items-center justify-end gap-3 border-t bg-white px-1 py-3">
                  <button
                    type="button"
                    onClick={onClose}
